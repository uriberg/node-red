        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (let i = 0; i < data.length; i++){
                    if (data[i].name === "energy-minimization" || data[i].name === "assign-hydrogens" || data[i].name === "ligand-file-conversion" || data[i].name === "protein-preparation" || data[i].name === 'ligand-preparation'){
                        newData.push(data[i]);
                        console.log(newData);
                    }
                }

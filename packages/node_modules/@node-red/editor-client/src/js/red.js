...
var RED = (function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (let i = 0; i < data.length; i++){
                    if (data[i].name === "energy-minimization" || data[i].name === "assign-hydrogens" || data[i].name === "ligand-file-conversion" || data[i].name === "protein-preparation" || data[i].name === 'ligand-preparation' || data[i].name === 'pymol-fetch' || data[i].name === 'docking' || data[i].name === 'molecular-dynamics'){
                        newData.push(data[i]);
                        console.log(newData);
                    }
                }
    ...
    function completeLoad() {
        ...
        $elem[0].style.setProperty('height', 'auto', 'important');
